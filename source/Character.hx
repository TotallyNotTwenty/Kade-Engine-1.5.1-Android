...
/*musicians lmao
			case 'max':
				tex = Paths.getSparrowAtlas('mayhem/Max', 'shared');
				frames = tex;
				...
				addOffset("singLEFT", 45, 43);
				addOffset("singDOWN", 3, 0);

				playAnim('idle');

			case 'abel':
				tex = Paths.getSparrowAtlas('mayhem/Abel', 'shared');
				frames = tex;
...
*/
			...
			case 'cj':
				tex = Paths.getSparrowAtlas('mayhem/cj_assets','shared');
				frames = tex;
			...
			case 'ruby':
				tex = Paths.getSparrowAtlas('mayhem/ruby_assets','shared');
				frames = tex;
		...
		case 'duet':
				tex = Paths.getSparrowAtlas('mayhem/duet_assets', 'shared');
				frames = tex;
