...
//here goes mayhem babe~ lmaoooooo
  ...
  var max:FlxSprite;
    ...
    case 'festivalDay':
        ...
        abel.animation.addByPrefix('idle', 'MAXIDLE', 24, false);
        abel.animation.addByPrefix('singUP', 'MAXUP', 24, false);
        abel.animation.addByPrefix('singDOWN', 'MAXDOWN', 24, false);
        abel.animation.addByPrefix('singLEFT', 'MAXLEFT', 24, false);
        abel.animation.addByPrefix('singRIGHT', 'MAXRIGHT', 24, false);
